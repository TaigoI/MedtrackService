...
import com.medtrack.backend.auth.JwtAuthFilter;
import com.medtrack.backend.auth.MedtrackUserDetailsService;
...
public class SecurityConfig {
    ...
    @Autowired
    private MedtrackUserDetailsService userDetailsService;
